...
export default function FinderAuthModal(props: any) {
	const [newUserState, setNewUserState] = useState(true);
	const { setFinderLoginModal } = useContext(AppContext);
			...
			<div className="overlay">
				<div className="modal w-full md:w-1/2" ref={node}>
					...
					<div className="modal-header">
						<h3 className="pt-3 pb-5 text-center font-bold text-2xl fnd-primary">
