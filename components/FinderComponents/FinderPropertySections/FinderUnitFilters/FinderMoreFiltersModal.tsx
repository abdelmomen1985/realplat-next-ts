  ...
  return (
    <>
      ...
      <div className="relative font-noto-sans w-11/12 mx-auto">
        <button
          className="dd-header text-lg md:text-base  w-11/12  border py-2 px-2 border-gray-400 bg-white rounded-md font-medium filter-button"
        ...
        {isModalOpen && (
          <div className="overlay">
            <section className="modal w-full md:w-1/2 text-base">
              <div
