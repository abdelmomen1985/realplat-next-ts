	...
	return (
		<section className="w-full">
			<div className="mt-16 mb-10 mx-auto w-4/5 bg-outline-primary">
				<div
					className={clsx(
						finder ? 'bg-red' : 'bg-primary',
						'w-full text-white flex justify-between items-center px-10 py-4'
					)}
				>
					<button
					...
					<button
						...
						className={clsx(
							currentTap === 4 ? 'text-opacity-100' : 'text-opacity-50',
							currentTap === 4 ? styles.activeTab : ' ',
							' text-center bg-transparent border-none outline-none focus:outline-none cursor-pointer text-white text-lg'
						)}
					>
