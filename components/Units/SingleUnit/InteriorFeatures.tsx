  ...
  return (
    <div className="border-gray-300 rounded-md shadow-md">
      ...
      >
        ...
        <span className="text-2xl font-medium mx-4 capitalize">{t('interiorFeat')}</span>
      </h3>
      <ul className="list-disc my-5 py-4 px-5 mx-3 flex flex-wrap justify-between items-center">
        <li className="my-2 text-text-secondary text-lg font-medium">{t('noRooms')}: 5</li>
        <li className="my-2 text-text-secondary text-lg font-medium">{t('typeRooms')}: 3 {t('bedrooms')}{t('comma')} 1 {t('kitchen')}{t('comma')} 2 {t('bathrooms')}</li>
      </ul>
    </div>
  )
}
