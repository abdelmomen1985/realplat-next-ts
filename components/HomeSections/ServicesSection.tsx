    ...
    <section className="w-full py-2 px-3 my-2">
      ...
      <div className="my-10 grid grid-cols-1 md:grid-cols-3 grid-rows-3 md:grid-rows-1 gap-5 ">
        {services.map((service, i) => (
          <div key={i} className="w-4/5 mx-auto flex flex-wrap flex-col justify-center items-center">
            <img src={service.icon} style={{ width: '90px', height: '90px' }} className="max-w-full" />
