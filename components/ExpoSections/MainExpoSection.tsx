  ...
  return (
    <>
      <section
        ...
        style={{
          background:
            "linear-gradient(rgba(0,0,0,0.2), rgba(0,0,0,0.5)), url('/images/hero/expo-hero-1.png') center center / cover no-repeat fixed",
      ...
      >
        <div className="w-full md:w-2/4">
          ...
          <p className="text-base text-white">{t("expoDesc")}</p>
