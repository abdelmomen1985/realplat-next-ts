const common = {
	...
	expoDesc:
		'Lovely 4 BR, 2 Bath home with Vaulted Ceilings, Open Concept Kitchen & Family Room, Solid Flooring throughout (tumbled Travertine everywhere except BRs which are Wood floors).',
