			...
			<div className="container px-3 mx-auto">
				...
				<div className="my-3 border-gray-300 rounded-md shadow-md">
					...
					>
						...
						<span className="text-2xl font-medium mx-4 capitalize">
							{t('location')}
						</span>
					</h3>
					<RegularMap
						...
						defaultCenter={{
							lat: singleUnitState.lat,
							lng: singleUnitState.lng,
						}}
					/>
				</div>
			</div>
