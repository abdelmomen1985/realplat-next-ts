...
const SingleExpoPage = ({ unit }: { unit: Unit }) => {
	...
	return (
		<FinderLayout>
			<div className="container font-noto-sans mx-auto px-3">
				...
				<div className="grid  grid-cols-1 md:grid-cols-3 gap-4 my-4">
					<div className="col-span-1 md:col-span-2">
						<div className="flex justify-start items-center px-3">
							<span className="bg-success mx-2 capitalize text-white px-3 py-1 rounded-md border-transparent">
								verified
							</span>
							<span className="bg-info mx-2 capitalize text-white px-3 py-1 rounded-md border-transparent">
								New
							</span>
						</div>
